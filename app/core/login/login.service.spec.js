describe('login.service', function () {
  ...
  // declare globals
  var LoginService;
  var $q, $window, $firebaseAuth, localdb, config, $rootScope;
  ...
  beforeEach(function () {
	...
	beforeEach(inject(function(_LoginService_, _$firebaseAuth_, _localdb_, _$q_, _$window_, _config_, _$rootScope_) {
