describe('login.service', function () {
	...
	// mock user data
	var userA = mockUserData('a');
	var userB = mockUserData('b');

	// mock errors
	var invalidPasswordResponse = mockErrorData('invalidPassword');
	var userNotFoundResponse = mockErrorData('userNotFound');
	...
	function mockUserData(userCode) {
		if (userCode === 'a') {
			return {
	...
	function mockErrorData(errorCode) {
		switch (errorCode) {
		...
		default:
			return {
				code: 'unknown mocked error',
				message: 'this unknown error was generated by the test suite',
				email: 'error@err.or',
				credential: {}
			};
		}
